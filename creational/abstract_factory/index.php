...
require_once('NYToyFactory.php');
require_once('Toys/NYMazeToy.php');
require_once('Toys/NYPuzzleToy.php');
$newYorkToyFactory = new NYToyFactory();
var_dump($newYorkToyFactory->makeMaze());
echo "\n";
var_dump($newYorkToyFactory->makePuzzle());
echo "\n";
